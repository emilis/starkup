...
function nodeToHtml( node ){
    ...
    switch( node.nodeType ){
        ...
        case nodes.JsValue:
            ...
            return quoteHtml( eval( node.children[0] ).toString() );
            break;

        case nodes.JsExpr:

            return eval( node.children[0] ).toString();
            break;
        ...
        default:
            throw Error( "Don't know how to convert node (" + node.nodeTypeName + ") to HTML." );
    }
}///
